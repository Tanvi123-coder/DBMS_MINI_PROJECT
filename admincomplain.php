...
<table class="table table-striped">
  ...
  $selectquery = "SELECT * FROM complain where societyname='$societyname'";
  ...
  while($result = mysqli_fetch_assoc($query)){
   ...
   <td> <a href="edit.php?id=<?php echo $result['CId']; ?> "> <i class="fa fa-edit btnedit" aria-hidden="true"></i> </a> </td>
...
<div class=details>
<a href="details.php"> <button class="btn btn-success"> Details </button> </a>
</div>
</div>
